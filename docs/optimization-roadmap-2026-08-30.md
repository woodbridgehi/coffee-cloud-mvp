...
实施进展：R0/B1.1 经 pi 提交及复核后，Codex 直接补充修复与验证，见 [B1.1 修复记录](mqtt-lifecycle-review-2026-08-30.md)。后端 `8baf0ae` 已发布 VPS，模拟器 `84a95d8` 已上传源码归档，见 [发布记录](releases/2026-08-30-b11.md)。下列 A1/A2 基线和历史验收数字保留，B1.2/D1 仍未实施。

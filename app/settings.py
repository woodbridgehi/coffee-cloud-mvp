...
class Settings(BaseSettings):
    ...
    simulator_bootstrap_enabled: bool = Field(default=False, alias="SIMULATOR_BOOTSTRAP_ENABLED")
    simulator_pairing_ttl_seconds: int = Field(default=900, alias="SIMULATOR_PAIRING_TTL_SECONDS", ge=60, le=3600)
    simulator_payment_mode: Literal["TEST_FREE", "ONLINE"] = Field(default="TEST_FREE", alias="SIMULATOR_PAYMENT_MODE")
    ...
    public_read_rate_limit: int = Field(default=240, alias="PUBLIC_READ_RATE_LIMIT", ge=1)
    public_write_rate_limit: int = Field(default=30, alias="PUBLIC_WRITE_RATE_LIMIT", ge=1)
    public_sse_limit: int = Field(default=1000, alias="PUBLIC_SSE_LIMIT", ge=1)
    ...
    public_payment_mode: Literal["TEST_FREE", "ONLINE"] = Field(default="TEST_FREE", alias="PUBLIC_PAYMENT_MODE")
    ...
    history_cleanup_batch_size: int = Field(default=500, alias="HISTORY_CLEANUP_BATCH_SIZE", ge=100, le=5000)

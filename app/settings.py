...
class Settings(BaseSettings):
    ...
    telemetry_online_ttl_seconds: int = Field(default=120, alias="TELEMETRY_ONLINE_TTL_SECONDS", ge=10, le=3600)
    ...
    run_database_migrations: bool = Field(default=True, alias="RUN_DATABASE_MIGRATIONS")
    run_order_sse_listener: bool = Field(default=True, alias="RUN_ORDER_SSE_LISTENER")
    ...
    offline_threshold_seconds: int = Field(default=90, alias="OFFLINE_THRESHOLD_SECONDS", ge=5, le=3600)
    ...
    payment_pending_ttl_seconds: int = Field(default=900, alias="PAYMENT_PENDING_TTL_SECONDS", ge=60, le=86400)
    ...
    # Separate identity preserves historical sandbox queries/refunds during a switch.
    alipay_mock_gateway: str | None = Field(default=None, alias="ALIPAY_MOCK_GATEWAY")
    alipay_mock_app_id: str | None = Field(default=None, alias="ALIPAY_MOCK_APP_ID")
    alipay_mock_app_private_key_file: str | None = Field(default=None, alias="ALIPAY_MOCK_APP_PRIVATE_KEY_FILE")
    alipay_mock_public_key_file: str | None = Field(default=None, alias="ALIPAY_MOCK_PUBLIC_KEY_FILE")
    ...
    maintenance_interval_seconds: int = Field(default=3600, alias="MAINTENANCE_INTERVAL_SECONDS", ge=60, le=86400)
    heartbeat_retention_days: int = Field(default=7, alias="HEARTBEAT_RETENTION_DAYS", ge=1, le=365)
    mqtt_inbox_retention_days: int = Field(default=30, alias="MQTT_INBOX_RETENTION_DAYS", ge=1, le=3650)
    device_event_retention_days: int = Field(default=90, alias="DEVICE_EVENT_RETENTION_DAYS", ge=7, le=3650)
    processed_outbox_retention_days: int = Field(default=14, alias="PROCESSED_OUTBOX_RETENTION_DAYS", ge=1, le=365)
